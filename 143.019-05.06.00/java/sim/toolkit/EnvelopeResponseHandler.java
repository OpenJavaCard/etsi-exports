...
public final class EnvelopeResponseHandler extends EditHandler {
     ...
     *      command.</ul>
     */
    public void post(byte statusType) throws APDUException,ToolkitException{
    }
     ...
     *      command.</ul>
     */
    public void postAsBERTLV(byte statusType, byte tag) throws APDUException,ToolkitException {
    }
