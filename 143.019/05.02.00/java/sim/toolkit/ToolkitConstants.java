 ...
 public interface ToolkitConstants
{
    ...
    public static final byte EVENT_EVENT_DOWNLOAD_LANGUAGE_SELECTION    = (byte)20;
    /** Event : Event Download - Browser Termination = 21                   */
    public static final byte EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION   = (byte)21;
    /** Event : Event Download - Data Available = 22                        */
    public static final byte EVENT_EVENT_DOWNLOAD_DATA_AVAILABLE 	= (byte)22;
    /** Event : Event Download - Channel Status = 23                        */
    public static final byte EVENT_EVENT_DOWNLOAD_CHANNEL_STATUS        = (byte)23;
    /** Event : Cell Broadcast Data Download Formatted = 24                 */
    public static final byte EVENT_FORMATTED_SMS_CB                     = (byte)24;
    /** Event : First Command after GSM application selection = 127     */
    public static final byte EVENT_FIRST_COMMAND_AFTER_SELECT           = (byte)127 ;
    ...
    /** Simple-TLV : Bearer Descrition tag                           = 0x35 */
    public static final byte TAG_BEARER_DESCRIPTION	             = (byte)0x35;
    /** Simple-TLV : Channel Data tag                                = 0x36 */
    public static final byte TAG_CHANNEL_DATA		             = (byte)0x36;
    /** Simple-TLV : Channel Data length tag                         = 0x37 */
    public static final byte TAG_CHANNEL_DATA_LENGTH	             = (byte)0x37;
    /** Simple-TLV : Channel Status tag                              = 0x38 */
    public static final byte TAG_CHANNEL_STATUS		             = (byte)0x38;
    /** Simple-TLV : Buffer Size tag                                 = 0x39 */
    public static final byte TAG_BUFFER_SIZE		             = (byte)0x39;
    /** Simple-TLV : Card reader identifier tag                      = 0x3A */
    public static final byte TAG_CARD_READER_IDENTIFIER              = (byte)0x3A;
    /** Simple-TLV : SIM/ME interface transport level tag            = 0x3C */
    public static final byte TAG_SIM_ME_INTERFACE_TRANSPORT_LEVEL    = (byte)0x3C;
    /** Simple-TLV : Other address (data destination address)        = 0x3E */
    public static final byte TAG_OTHER_ADDRESS                       = (byte)0x3E;
    /** Simple-TLV : Network Access Name                             = 0x47 */
    public static final byte TAG_NETWORK_ACCESS_NAME                 = (byte)0x47;
    ...
    public static final byte PRO_CMD_OPEN_CHANNEL	             = (byte)0x40;
    /** Type of proactive command : Close Channel                    = 0x41 */
    public static final byte PRO_CMD_CLOSE_CHANNEL	             = (byte)0x41;
    /** Type of proactive command : Receive Data                     = 0x42 */
    public static final byte PRO_CMD_RECEIVE_DATA	             = (byte)0x42;
    /** Type of proactive command : Send Data                        = 0x43 */
    public static final byte PRO_CMD_SEND_DATA		             = (byte)0x43;
    /** Type of proactive command : Get Channel Status               = 0x44 */
    public static final byte PRO_CMD_GET_CHANNEL_STATUS	             = (byte)0x44;
    ...
    /** Device Identity :  Channel 0                                 = 0x20 */
    public static final byte DEV_ID_CHANNEL_BASE		     = (byte)0x20;
    /** Device Identity :  Channel 1                                 = 0x21 */
    public static final byte DEV_ID_CHANNEL_1		             = (byte)0x21;
    /** Device Identity :  Channel 2                                 = 0x22 */
    public static final byte DEV_ID_CHANNEL_2		             = (byte)0x22;
    /** Device Identity :  Channel 3                                 = 0x23 */
    public static final byte DEV_ID_CHANNEL_3		             = (byte)0x23;
    /** Device Identity :  Channel 4                                 = 0x24 */
    public static final byte DEV_ID_CHANNEL_4		             = (byte)0x24;
    /** Device Identity :  Channel 5                                 = 0x25 */
    public static final byte DEV_ID_CHANNEL_5		             = (byte)0x25;
    /** Device Identity :  Channel 6                                 = 0x26 */
    public static final byte DEV_ID_CHANNEL_6		             = (byte)0x26;
    /** Device Identity :  Channel 7                                 = 0x27 */
    public static final byte DEV_ID_CHANNEL_7		             = (byte)0x27;
    ...
    /** Genereal Result : Bearer independent protocoll error         = 0x3A */
    public static final byte RES_ERROR_BEARER_INDEPENDENT_PROTOCOL_ERROR = (byte)0x3A;
}
