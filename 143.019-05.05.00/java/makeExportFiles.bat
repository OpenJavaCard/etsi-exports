...
IF "%JC21%" == "" SET JC21=D:\Java\Javacard\java_card_kit-2_1_2

echo Run Sun Compiler for TOOLKIT package 
javac  -g -target 1.1 -classpath D:\Java\Javacard\ETSI_SMG9\43019-550\Annex_A_Java;%JC21%\lib\api21.jar sim\toolkit\*.java 

echo Run Sun Compiler for ACCESS package  
javac  -g -target 1.1 -classpath D:\Java\Javacard\ETSI_SMG9\43019-550\Annex_A_Java;%JC21%\lib\api21.jar sim\access\*.java 

echo.
REM echo Run Sun JavaCard Converter for TOOLKIT package   
SET JC21LIB=%JC21%\lib
java -jar %JC21LIB%\converter.jar -config sim\toolkit\toolkit.opt 

echo.
REM echo Run Sun JavaCard Converter for ACCESS package 
java -jar %JC21LIB%\converter.jar -config sim\access\access.opt 
